		...
		<div class="row">
									...
									<tr>
										...
										<td><a
											...
											class="btn btn-outline-info btn-sm
												text-info"
											href="getContactById?contactId=${ob.contactId}">EDIT</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
			...
			<div class="col-md-3">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <a href="getAllContacts" class="btn btn-warning btn-block">
							<i class="fa fa-plus-circle"></i> Get All Active Employee
						</a>
					</div>
