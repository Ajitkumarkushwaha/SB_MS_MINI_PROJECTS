	...
	<div class="row mb-4">
					...
					<form:form action="saveContact?contactId=${contact.contactId}"
						...
						<div class="form-group">
							<form:input class="form-control" path="contactName"
								placeholder="Employee Name" type="text" required="required"/>
						</div>
						<div class="form-group">
							<form:input class="form-control" path="contactEmail"
								placeholder="Employee Email" type="email" required="required"/><span id="duplicateEmaliMsg" class="text-danger"></span>
						</div>
						<div class="form-group">
							<form:input class="form-control" path="contactNum"
								placeholder="Employee Contact Num" type="number" required="required" />
						</div>
		...
		<div class="col-md-4.5">
			...
			<div class="row mb-3">
				...
				<div class="col-md-8">
					<div class="col-md-2"></div>
					<a href="getAllContacts" class="btn btn-success btn-block"> <i
		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<h6>
						Developed And Maintained by <a class="text-warning"
			...
			function(event) {
				$("#contactEmail").blur(
						function() {
							...
							$.ajax({
								type : "GET",
								url : "validateEmail?contactEmail=" + emailId,
